...
:writeToRegistry
    for /f "tokens=4" %%i in ('reg add HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager\ /v SubscribedContent-338387Enabled /t REG_DWORD /d 0 /f 2^>^&1') do set OUTPUT=%%i   
